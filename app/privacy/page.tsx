      ...
      <section className="bg-gradient-to-br from-[var(--color-royal-blue)] via-blue-700 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6">
            <Badge className="bg-[var(--color-gold)] text-black hover:bg-[var(--color-gold)]/90">Data Protection</Badge>
            ...
            <p className="text-sm text-blue-200">Last updated: December 2024 | Effective Date: December 2024</p>
          </div>
        </div>
      </section>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-[var(--color-royal-blue)]">Introduction</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    School of the Year ("we," "our," or "us") is committed to protecting your privacy and ensuring the
                    security of your personal information. This Privacy Policy explains how we collect, use, disclose,
                    and safeguard your information when you participate in our inter-school academic and sports
                    competition.
                  </p>
                  <p>
                    This policy applies to all participants, including students, parents/guardians, school
                    administrators, and visitors to our website. By registering for our competition or using our
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        <strong>Student Data:</strong> Name, age, grade level, school name, contact information, profile
                        photographs
                      </li>
                      <li>
                        <strong>Parent/Guardian Data:</strong> Name, contact information, relationship to student,
                        consent records
                      </li>
                      <li>
                        <strong>School Data:</strong> School name, principal's information, school address, registration
                        certificates
                      </li>
                      <li>
                        <strong>Academic Records:</strong> Event registrations, test scores, performance data,
                        certificates earned
                      </li>
                      <li>
                        <strong>Medical Information:</strong> Fitness certificates, emergency contact information,
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>IP addresses, browser type, device information, operating system</li>
                      <li>Website usage data, page views, time spent on site, click patterns</li>
                      <li>Cookies and similar tracking technologies for website functionality</li>
                      <li>Login credentials and account security information</li>
                    </ul>
                  </div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <h4 className="font-semibold text-foreground">Competition Management:</h4>
                    ...
                    <div className="space-y-3">
                      <h4 className="font-semibold text-foreground">Safety & Security:</h4>
                      <ul className="list-disc list-inside space-y-1 text-sm ml-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p>
                        ...
                        conducting competitions, and serving participants. These providers have access to personal
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground">Educational Institutions:</h4>
                      <p>
                        We may share academic performance data with participating schools for educational purposes and
                        to facilitate scholarship opportunities, but only with appropriate consent.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p>
                        We may disclose information when required by law, court order, or government regulation, or when
                        we believe disclosure is necessary to protect our rights, safety, or the rights and safety of
                        others.
                      </p>
                    </div>

                    <div>
                      <h4 className="font-semibold text-foreground">Public Recognition:</h4>
                      <p>
                        Winner names, schools, and achievements may be published for recognition purposes, but only with
                        explicit consent from participants or their guardians.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-[var(--color-royal-blue)]">Data Security</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-950/20 p-4 rounded-lg border-l-4 border-yellow-500">
                    <p className="text-yellow-700 dark:text-yellow-300">
                      ...
                      protecting your information using industry-standard practices.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-[var(--color-royal-blue)]">Your Privacy Rights</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm">Withdraw consent for marketing communications at any time</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[var(--color-royal-blue)]/5 p-4 rounded-lg">
                    <p className="text-sm">
                      <strong>To exercise your rights:</strong> Contact our privacy team at privacy@schooloftheyear.com
                      or use the contact information provided below. We will respond to your request within 30 days.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-[var(--color-royal-blue)]">Data Retention</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      <strong>Competition Data:</strong> Retained for 7 years for record-keeping and verification
                      purposes
                    </li>
                    <li>
                      <strong>Academic Records:</strong> Maintained for scholarship and recognition purposes (with
                      consent)
                    </li>
                    <li>
                      <strong>Payment Information:</strong> Retained as required by financial regulations (typically 7
                      years)
                    </li>
                    <li>
                      <strong>Marketing Data:</strong> Retained until consent is withdrawn or account is deleted
                    </li>
                    <li>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-serif text-2xl font-bold text-[var(--color-royal-blue)]">Contact Us</h2>
                </div>
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <div className="bg-muted/50 p-6 rounded-lg space-y-3">
                    <div>
                      <h4 className="font-semibold text-foreground">Privacy Officer</h4>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <p>
                          <strong>Email:</strong> privacy@schooloftheyear.com
                        </p>
                        <p>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg border-l-4 border-[var(--color-royal-blue)]">
                    <p className="text-[var(--color-royal-blue)] text-sm">
                      <strong>Policy Updates:</strong> We may update this Privacy Policy periodically. We will notify
                      you of significant changes via email or website notice. Continued use of our services after
